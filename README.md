...
Site institucional e comercial estático para a Dolci Dri Confeitaria.
...
- WhatsApp real em `script.js`, campo `whatsappNumber`.
- Telefone, Instagram, e-mail, endereço/retirada e horário no bloco de contato do `index.html`.
- CNPJ, políticas comerciais, prazo mínimo e área de entrega no rodapé ou em nova seção.
- Fotos reais dos produtos ilustrativos quando estiverem disponíveis.
